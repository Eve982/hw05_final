...
Инструкция ориентирована на операционные системы Windows/MacOS и утилиту git bash.<br/>
Для прочих инструментов используйте аналоги команд для вашего окружения.

1. Клонируйте репозиторий и перейдите в него в командной строке:

если Вы используете SSH-протокол:
```
git clone git@github.com:Eve982/hw05_final.git
```
если Вы используете HTTPS-протокол:
```
https://github.com/Eve982/hw05_final.git
```
зайдите в папку проекта через терминал:
```
cd hw05_final
```
...
1. Просматривать, публиковать и редактировать свои публикации;
